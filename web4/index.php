...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  if (!$errors) {
    try {
      $stmt = $db->prepare("INSERT INTO application (names, phones, email, dates, gender, biography) VALUES (:names, :phones, :email, :dates, :gender, :biography)"); //исправлено
      $stmt->execute(array(
        'names' => $names, 
        'phones' => $phone, //исправлено
        'email' => $email, 
        'dates' => $date, //исправлено
        'gender' => $gender, 
        'biography' => $biography));
